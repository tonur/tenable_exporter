...
pub struct ScansDetails200ResponseFiltersInner {
    ...
    pub control: Option<Box<crate::models::ScansDetails200ResponseFiltersInnerControl>>,
}

impl ScansDetails200ResponseFiltersInner {
    pub fn new() -> ScansDetails200ResponseFiltersInner {
        ScansDetails200ResponseFiltersInner {
            name: None,
            readable_name: None,
            operators: None,
            control: None,
