...
pub struct VulnerabilitiesImportV2RequestAssetsInner {
    ...
    pub tenable_agent_id: Option<String>,
    /// The unique identifier for the [network](doc:manage-networks-tio) where Tenable.io assigns the asset during import.
    #[serde(rename = "tenable_network_id", skip_serializing_if = "Option::is_none")]
    pub tenable_network_id: Option<String>,
    ...
    pub vulnerabilities: Option<Vec<crate::models::VulnerabilitiesImportV2RequestAssetsInnerVulnerabilitiesInner>>,
}

impl VulnerabilitiesImportV2RequestAssetsInner {
    pub fn new() -> VulnerabilitiesImportV2RequestAssetsInner {
