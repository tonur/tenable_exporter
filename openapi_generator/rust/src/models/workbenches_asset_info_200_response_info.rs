...
pub struct WorkbenchesAssetInfo200ResponseInfo {
    ...
    pub sources: Option<Vec<crate::models::AssetsListAssets200ResponseAssetsInnerSourcesInnerInner>>,
    /// Category tags assigned to the asset in Tenable.io.
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<crate::models::WorkbenchesAssetInfo200ResponseInfoTagsInner>>,
...
impl WorkbenchesAssetInfo200ResponseInfo {
    pub fn new() -> WorkbenchesAssetInfo200ResponseInfo {
        WorkbenchesAssetInfo200ResponseInfo {
            time_end: None,
            time_start: None,
            id: None,
            uuid: None,
